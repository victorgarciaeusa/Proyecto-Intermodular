...
def get_feature_cols():
    return [
        ...
        "ma_7", "ma_14", "ma_21", "ma_28",
        "std_7", "std_14", "std_21", "std_28",
        "rolling_max_7", "rolling_min_7", "rolling_range_7",
        "lag7_vs_ma28", "lag1_vs_ma7",
...
def run_xgboost():
    ...
    mape_promo   = mape(results_df[results_df["promotion_flag"]==1]["y_true"],
                        results_df[results_df["promotion_flag"]==1]["y_pred"])
    mape_nopromo = mape(results_df[results_df["promotion_flag"]==0]["y_true"],
                        results_df[results_df["promotion_flag"]==0]["y_pred"])
    mape_sku = results_df.groupby("sku").apply(
